...
public:
    ...
    virtual EvalRes eval(CAS::Scope &scope, bool  lazy) const { return std::make_pair(CAS::TypeInfo::VOID, make_unique<OutputExpression>(operand->eval(scope, lazy).second)); }
