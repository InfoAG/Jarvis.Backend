...
CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT max_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &scope, const std::function<void(const std::string &)> &load, bool lazy, bool)
{
    try {
        auto argList = *static_cast<CAS::List*>(args.front()->eval(scope, load, lazy, true).get());
    ...
    } catch (const char *) { return nullptr; }
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT min_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &scope, const std::function<void(const std::string &)> &load, bool lazy, bool)
{
    try {
        auto argList = *static_cast<CAS::List*>(args.front()->eval(scope, load, lazy, true).get());
        if (argList.getOperands().empty()) return nullptr;
...
CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT range_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &scope, const std::function<void(const std::string &)> &load, bool lazy, bool direct)
{
    if (typeid(*(args.front())) == typeid(CAS::NumberValue) && typeid(*(args[1])) == typeid(CAS::NumberValue) && typeid(*(args.back())) == typeid(CAS::NumberValue)) {
        ...
        return CAS::List(std::move(result)).eval(scope, load, lazy, direct);
    } else return nullptr;
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT sum_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &scope, const std::function<void(const std::string &)> &load, bool lazy, bool direct)
{
    return static_cast<CAS::List*>(args.front().get())->sum()->eval(scope, load, lazy, direct);
}
...
CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT binom_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
...
CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT binompdf_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
...
CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT binomcdf_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
    if (typeid(*(args.front())) != typeid(CAS::NumberValue) || typeid(*(args.at(1))) != typeid(CAS::NumberValue) || typeid(*(args.back())) != typeid(CAS::NumberValue)) return nullptr;
    double result = 0;
...
CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT y_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
    if (typeid(*(args.front())) != typeid(CAS::VectorExpression)) return nullptr;
    return static_cast<const CAS::VectorExpression*>(args.front().get())->getY()->copy();
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT z_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
    if (typeid(*(args.front())) != typeid(CAS::VectorExpression)) return nullptr;
    return static_cast<const CAS::VectorExpression*>(args.front().get())->getZ()->copy();
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT sqrt_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
...
CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT length_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &scope, const std::function<void(const std::string &)> &load, bool lazy, bool direct)
{
    ...
    return CAS::Function("sqrt", std::move(sqrtArgs)).eval(scope, load, lazy, direct);
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT sin_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
    if (typeid(*(args.front())) != typeid(CAS::NumberValue)) return nullptr;
    return make_unique<CAS::NumberValue>(sin(static_cast<const CAS::NumberValue*>(args.front().get())->getValue()));
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT cos_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
    if (typeid(*(args.front())) != typeid(CAS::NumberValue)) return nullptr;
    return make_unique<CAS::NumberValue>(cos(static_cast<const CAS::NumberValue*>(args.front().get())->getValue()));
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT tan_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
    if (typeid(*(args.front())) != typeid(CAS::NumberValue)) return nullptr;
    return make_unique<CAS::NumberValue>(tan(static_cast<const CAS::NumberValue*>(args.front().get())->getValue()));
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT asin_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
    if (typeid(*(args.front())) != typeid(CAS::NumberValue)) return nullptr;
    return make_unique<CAS::NumberValue>(asin(static_cast<const CAS::NumberValue*>(args.front().get())->getValue()));
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT acos_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
    if (typeid(*(args.front())) != typeid(CAS::NumberValue)) return nullptr;
    return make_unique<CAS::NumberValue>(acos(static_cast<const CAS::NumberValue*>(args.front().get())->getValue()));
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT atan_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &, const std::function<void(const std::string &)> &, bool, bool)
{
    if (typeid(*(args.front())) != typeid(CAS::NumberValue)) return nullptr;
    return make_unique<CAS::NumberValue>(atan(static_cast<const CAS::NumberValue*>(args.front().get())->getValue()));
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT angle_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &scope, const std::function<void(const std::string &)> &load, bool lazy, bool direct)
{
    ...
    return CAS::Function("acos", std::move(acosArgs)).eval(scope, load, lazy, direct);
}

CAS::AbstractExpression::ExpressionP STDSHARED_EXPORT zero2d_jce(const CAS::AbstractExpression::Operands &args, CAS::Scope &scope, const std::function<void(const std::string &)> &load, bool lazy, bool direct)
{
    ...
    return CAS::List(std::move(listOps)).eval(scope, load, lazy, direct);
}
